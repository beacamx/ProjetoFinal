...
Interface_Jogo::Interface_Jogo(const string& nome_do_jogo)
    : Interface_Base(100, 100), nome_do_jogo(nome_do_jogo) {
...
void Interface_Jogo::Atualizar_Janela() {
    try {
        ...
        cerr << "Erro ao atualizar a janela: " << e.what() << endl;
    }
}
...
void Interface_Jogo::Eventos_Jogo() {
    ...
    try {
        ...
        cerr << "Erro ao processar eventos do jogo: " << e.what() << endl;
    }
}
...
void Interface_Jogo::Set_Janela() {
    try {
        ...
        cerr << "Erro ao definir a janela: " << e.what() << endl;
        exit(1);
    }
}
...
void Interface_Jogo::Run(){
    try {
        ...
        cerr << "Erro durante a execução do jogo: " << e.what() << endl;
    }
}
