...
public:
    ...
    jogador(std::string name, unsigned int wins_lig4, unsigned int wins_Reversi, unsigned int loses_lig4, unsignet int loses_Reversi) : _name(name), n_of_wins_lig4(wins_lig4), n_of_wins_Reversi(wins_Reversi), n_of_loses_lig4(loses_lig4), n_of_loses_Reversi(loses_Reversi) {}
    std::string get_name() { return _name; };
    unsigned int get_wins() { return n_of_wins_lig4 + n_of_of_wins_Reversi; };
